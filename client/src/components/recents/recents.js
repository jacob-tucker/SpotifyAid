                ...
                <div className="topTracks">
                    ...
                    {recentTracks.map((thing, i) => (
                        <div tabIndex="1" className="trackDetails" key={i}>
                            <a href={thing.track.preview_url} className="thePlayerButton"><img alt="spotifyplay" src={require("../topStuff/whiteplay.jpg")} /></a>
                            <img alt="album_cover" src={thing.track.album.images[0].url} />
